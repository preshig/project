...
<table cellspacing="0" cellpadding="0" border="0">
	<tr height="40" width="506"></tr>
		<td width="22">&nbsp;</td>
		<td width="800"><font size="5" ><b>CUSTOMER SERVICE - CONTACT US</b></font></td>
		<td width="22">&nbsp;</td>
	
</table>	

<table cellspacing="0" cellpadding="0" border="1" height="300" width="990" >
		<tr>
						<td width="250" height="41" font align="center"><h3> Our Contacts</h3> 
				
					
						<p align="left" font size="3">
								E-Mail ID- radiantfresh@gmail.com
								<br>
								<br>
								Postal Address- Radiant Fresh,
								<br>
								<br>
								PLOT NO.-7,  P.U.-4, SCHEME NO.-54, GROUND FLOOR,
								<br>
								<br>
								COMMERCIAL SHAGUN. INDORE, <br>
						  </p>
	</td>
...
<table class="form">							
	...
	<tr>&nbsp;</tr>
	<tr ><td width="22">&nbsp;</td> <td><h4><font color="black">Contact Form</font></h4></td><td><h4><font color="#black">&nbsp;</font></h4></td></tr>
	<tr><td width="22" >&nbsp;</td><td>First Name</td><td><input type="text" id="uname" maxlenght="15" pattern="[a-zA-Z]{3,15}" required></td></tr>
	<tr><td width="22" >&nbsp;</td><td>Last Name</td><td><input type="text" id="uname" maxlenght="15" pattern="[a-zA-Z]{3,15}" required></td></tr>
	<tr><td width="22" >&nbsp;</td><td>Your Email</td><td><input type="email" id="uid" required ></td></tr>
	<tr><td width="22" >&nbsp;</td><td>Your Message</td><td><textarea  color="black" value="" rows="10" cols="50"></textarea></td></tr>
	
	</td></tr>
	
	
	<tr ><td width="22" >&nbsp;</td><td height="40" align="right"> <input  type="submit" value="clear"> 
